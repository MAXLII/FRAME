...
set "PUBLISHER=LWX"
set "ISS_FILE=%~dp0installer\dr_ssip_monitor_installer.iss"
...
echo [INFO] Building FRAME application bundle for %APP_NAME% installer...
...
echo [INFO] Building %APP_NAME% installer package...
...
echo.
echo [OK] Installer build complete: %~dp0dist\installer\DR_SSIP_Monitor-Setup-%APP_VERSION%.exe
